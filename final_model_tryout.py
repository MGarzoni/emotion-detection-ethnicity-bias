...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Activation, Dropout, Flatten, Dense, Rescaling
...
disp = ConfusionMatrixDisplay(confusion_matrix=confusion_matrix(y_test, np.argmax(hypermodel.predict(X_test), axis=-1)))
